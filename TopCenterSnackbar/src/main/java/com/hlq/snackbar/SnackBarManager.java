...
class SnackBarManager {
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar,
                    NiceSnackBar.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private void scheduleTimeoutLocked(SnackBarRecord r) {
        if (r.duration == NiceSnackBar.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == NiceSnackBar.LENGTH_SHORT) {
    ...
    void handleTimeout(SnackBarRecord record) {
        synchronized (mLock) {
            if (mCurrentSnackbar == record || mNextSnackbar == record) {
                cancelSnackbarLocked(record, NiceSnackBar.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
