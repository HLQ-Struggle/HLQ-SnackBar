...
import static com.hlq.snackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final void showView() {
        ...
        if (ViewCompat.isLaidOut(mView)) {
            ...
            mView.setOnLayoutChangeListener((view, i, i1, i2, i3, i4, i5, i6, i7) -> {
    ...
    private void animateViewOut(final int event) {
        if (Build.VERSION.SDK_INT >= 12) {
            ...
            final Animation anim = android.view.animation.AnimationUtils.loadAnimation(mView.getContext(), R.anim.design_snackbar_out);
            anim.setInterpolator(FAST_OUT_SLOW_IN_INTERPOLATOR);
            anim.setDuration(ANIMATION_DURATION);
            anim.setAnimationListener(new Animation.AnimationListener() {
                @Override
